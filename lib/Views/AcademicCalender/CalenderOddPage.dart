...
class CalenderOddPage extends StatelessWidget {
  const CalenderOddPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Academic Planner - ODD"),
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              return ListView.builder(
                  itemCount: snapshot.data!.calOdd.length,
                  itemBuilder: ((context, index) {
                    String param = snapshot.data!.calOdd.keys.elementAt(index);
                    List<List<dynamic>>? value = snapshot.data!.calOdd[param];
