...
import 'quicklrnMarks.dart';

class QuicklrnMarksBuilder extends StatelessWidget {
  const QuicklrnMarksBuilder({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          return MarksBuilder(snapshot.data!);
  ...
  Widget MarksBuilder(QuicklrnApi snapshot) {
    // final controller = Get.find<AcadDataController>();
    return QuicklrnMarks(studentInfo: snapshot);
  }
}
